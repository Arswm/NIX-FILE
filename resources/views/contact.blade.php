...
@section('content')
  ...
  <div class="mx-6">
    ...
    <div class="bg-white shadow-custom rounded-3xl flex justify-center w-full mx-auto flex-wrap mb-12 flex-col-reverse lg:flex-row">
      <div class="p-4 lg:p-8 items-center w-full lg:w-[50%]">
        ...
        <p class="text-text-color text-center mb-8">
          در کمتر از ۳۰ دقیقه با شما تماس می‌گیریم
        </p>
        <form action="">
          <div class="relative mb-4">
            <input type="text"
                   id="name"
                   class="block border px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-full border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-primary-color peer"
                   placeholder=" "/>
            <label
              for="name"
          ...
          <div class="relative">
            <input
              id="number"
              type="text"
              class="block mb-4 border px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-full border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-primary-color peer"
              placeholder=" "/>
            <label
              for="number"
              class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-primary-color peer-focus:dark:text-primary-color peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2
          ...
          <button type="submit" class="py-3 bg-primary-color/90 text-white block w-full rounded-full hover:bg-primary-color transition-all">
            ثبت درخواست تماس
          </button>
        </form>
      </div>
